...
def render_retail(df):
    ...
    if st.button("Apply Filters"):
        ...
        for _, row in filtered_df.iterrows():
            ...
            whatsapp_columns = [df.columns[2], df.columns[3], df.columns[4], df.columns[6], df.columns[8], df.columns[9], df.columns[10], df.columns[11], df.columns[12]]  # Custom columns for WhatsApp message
