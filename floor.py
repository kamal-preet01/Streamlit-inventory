...
def render_floor(df):
    ...
    if st.button("Apply Filters"):
        ...
        for _, row in filtered_df.iterrows():
            ...
            whatsapp_columns = [df.columns[2], df.columns[5], df.columns[6], df.columns[7], df.columns[8], df.columns[9], df.columns[10], df.columns[11], df.columns[12], df.columns[14], df.columns[15], df.columns[16], df.columns[17], df.columns[18]]  # Custom columns for WhatsApp message
