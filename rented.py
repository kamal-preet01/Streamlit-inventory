...
def render_rented(df):
    ...
    whatsapp_columns = [df.columns[6], df.columns[7], df.columns[9], df.columns[10], df.columns[11], df.columns[12], df.columns[13], df.columns[18]]
...
def share_selected_properties(selected_properties, custom_column_names, whatsapp_columns):
    ...
    whatsapp_message = "Check out these Rented properties:\n\n"
